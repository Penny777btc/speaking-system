...
2. 把本仓库的 **English-Speaking-System 整个文件夹**(绿色 Code 按钮 → Download ZIP 解压后就有)拖进你仓库的根目录(在访达/资源管理器里拖即可)
...
更深的原理和维护知识见 [advanced/claude-skill/speaking-system/references/gotchas.md](../advanced/claude-skill/speaking-system/references/gotchas.md)(写给 AI 维护者,但人也能读)。
